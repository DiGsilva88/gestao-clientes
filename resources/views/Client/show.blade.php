        ...
        <div class="col-md-6">
            ...
            <div class="card border-0 border-top border-primary border-3 shadow-sm p-4">
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
                    <h4 class="fw-bold m-0 text-dark">Informações do Cliente</h4>
                </div>
                ...
                <div class="pt-2 border-top d-flex flex-wrap gap-3">
                    ...
                    <form action="{{ route('client.destroy', $client->id) }}" method="POST"
                        ...
                        <button type="submit"
                                ...
                                onclick="return confirm('Tem a certeza que quer eliminar este cliente?')">
